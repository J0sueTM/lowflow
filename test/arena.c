...
static MunitResult
test_arena_lifetime(const MunitParameter params[], void *data)
{
    (void)params;
    (void)data;
...
static MunitResult
test_arena_malloc(const MunitParameter params[], void *data)
{
    (void)params;
    (void)data;
...
static const MunitSuite arena_test_suite = { (char *)"/arena",
                                             arena_tests,
                                             0,
                                             0 };
